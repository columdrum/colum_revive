...
private ["_receiver", "_state", "_ace_w_cpr_attendant"];
...
GVAR(cancel_cpr_action) = player addAction [localize "STR_ACE_WOUNDS_CANCEL_CPR", QUOTE(PATHTOF(cancel_cpr.sqf)), [], 0, false, true];
